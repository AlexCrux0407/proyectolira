...
@section('content')
  <div class="card mb-4">
    ...
    <div class="row">
      ...
      <div class="btn-group">
        ...
        <a href="{{ route('reportes.historial.sucursal', $sucursal->id) }}" class="btn btn-info">
  ...
  <div class="card mb-4">
    ...
    <div class="row mb-2 p-2 border-bottom">
      <div class="col-md-1">
      <div class="user-icon bg-dark text-white rounded-circle d-flex align-items-center justify-content-center"
      ...
      <button class="btn btn-sm btn-danger" onclick="setEmpleadoId('{{ $empleado->id }}')" data-bs-toggle="modal"
      data-bs-target="#deleteEmpleadoModal">Eliminar</button>
      </div>
    </div>
    @endforeach
    @else
    ...
    @endif
    <div class="mt-3">
      <a href="{{ route('empleados.create', ['sucursal' => $sucursal->id]) }}" class="btn btn-success">Agregar
      Empleado</a>
    </div>
    </div>
  </div>
  ...
  <div class="modal fade" id="deleteSucursalModal" tabindex="-1" aria-labelledby="deleteSucursalModalLabel"
    aria-hidden="true">
  ...
  <div class="modal fade" id="deleteEmpleadoModal" tabindex="-1" aria-labelledby="deleteEmpleadoModalLabel"
    aria-hidden="true">
    <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
